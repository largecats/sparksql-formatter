...
class SparkSQL:
    ...
    class Keyword:
        RESERVED_KEYWORDS = [
            ...
            'OVER', 'OVERLAPS', 'PARTITION', 'POSITION', 'PRIMARY', 'REFERENCES', 'REPAIR', 'RIGHT', 'ROW', 'ROWS',
            'SCHEMA', 'SECOND', 'SELECT', 'SEMI', 'SESSION_USER', 'SET', 'SKEWED', 'SOME', 'SORT', 'START', 'TABLE',
            'THEN', 'TO', 'TRAILING', 'TRUE', 'TRUNCATE', 'UNBOUNDED', 'UNION', 'UNIQUE', 'UNKNOWN', 'UPDATE', 'USE',
            'USER', 'USING', 'VALUES', 'VIEW', 'WHEN', 'WHERE', 'WINDOW', 'WITH', 'YEAR'
        ]
