...
class SparkSQL:
    ...
    class Keyword:
        RESERVED_KEYWORDS = [
            ...
            'KEYS', 'LATERAL', 'LEADING', 'LEFT', 'LIKE', 'LIMIT', 'LOCAL', 'MINUS', 'MINUTE', 'MONTH', 'NATURAL', 'NO',
            'NOT', 'NULL', 'OF', 'ON', 'ONLY', 'OPTION', 'OPTIONS', 'OR', 'ORDER', 'OUT', 'OUTER', 'OVER', 'OVERLAPS',
            'PARTITION', 'POSITION', 'PRIMARY', 'REFERENCES', 'REPAIR', 'RIGHT', 'ROW', 'ROWS', 'SCHEMA', 'SECOND',
            'SELECT', 'SEMI', 'SESSION_USER', 'SET', 'SKEWED', 'SOME', 'SORT', 'START', 'TABLE', 'THEN', 'TO',
            'TRAILING', 'TRUE', 'TRUNCATE', 'UNBOUNDED', 'UNION', 'UNIQUE', 'UNKNOWN', 'UPDATE', 'USE', 'USER', 'USING',
        ...
        NON_RESERVED_KEYWORDS = [
            ...
            'LOCK', 'LOCKS', 'LOGICAL', 'MACRO', 'MAP', 'MATCHED', 'MERGE', 'MSCK', 'NAMESPACE', 'NAMESPACES', 'NULLS',
            'OUTPUTFORMAT', 'OVERLAY', 'OVERWRITE', 'PARTITIONED', 'PARTITIONS', 'PERCENT', 'PIVOT', 'PLACING',
            'PRECEDING', 'PRINCIPALS', 'PROPERTIES', 'PURGE', 'QUERY', 'RECORDREADER', 'RECORDWRITER', 'RECOVER',
            'REDUCE', 'REFRESH', 'RENAME', 'REPLACE', 'RESET', 'RESTRICT', 'REVOKE', 'RLIKE', 'ROLE', 'ROLES',
            'ROLLBACK', 'ROLLUP', 'SEPARATED', 'SERDE', 'SERDEPROPERTIES', 'SETS', 'SHOW', 'SORTED', 'STATISTICS',
            'STORED', 'STRATIFY', 'STRUCT', 'SUBSTR', 'SUBSTRING', 'TABLES', 'TABLESAMPLE', 'TBLPROPERTIES',
            'TEMPORARY', 'TERMINATED', 'TOUCH', 'TRANSACTION', 'TRANSACTIONS', 'TRANSFORM', 'TRIM', 'UNARCHIVE',
            'UNCACHE', 'UNLOCK', 'UNSET', 'VIEWS'
        ]
